...
class UserController extends Controller
{
    ...
    public function login(Request $request) {
        ...
        if( !$this->accessOnGalyon($user->id) ) {
            return response()->json( array(
                "success" => false,
                "message"=>"You are currently not allowed to access Galyon!"
            ) );
        }
        ...
        return response()->json(array("success"=>false,"message"=>"Authentication invalid!"));
    }
